# Silero TTS Server
Сервер синтеза речи на базе модели Silero TTS v5.5_ru.
...
- **Штакет:** За базовый скрипт и исходные материалы [Видео-инструкция](https://www.youtube.com/watch?v=r7eI_gON3X0).
- **Виктор Шацков:** За адаптацию голосов и реализацию автокорректировки скорости [Видео-инструкция](https://www.youtube.com/watch?v=JGq7Xxvr5oI).
